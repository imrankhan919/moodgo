  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {event.isFeatured && (
          <span className="absolute top-3 right-3 px-2 py-1 text-[10px] font-bold text-[#8B5CF6] bg-[#8B5CF6]/10 border border-[#8B5CF6]/20 rounded-full uppercase tracking-wider" style={{ fontFamily: 'DM Sans, sans-serif' }}>
            ⭐ Featured
          </span>
        )}
      </div>
